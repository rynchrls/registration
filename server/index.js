...
// API routing
app.use("https://registration-server-nine.vercel.app/auth", route);
app.use('https://registration-server-nine.vercel.app/auth', router)

app.use('https://registration-server-nine.vercel.app/auth', (req, res) => {
